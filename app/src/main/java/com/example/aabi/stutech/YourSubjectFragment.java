...
public class YourSubjectFragment extends Fragment {
    ...
    static String subjectName, teacherSubject, teacherDesig;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(YourSubjectFragment.this).load(currentUser.getPhotoUrl()).into(myProfilePic);
    ...
    private void addPost(String imageDownlaodLink, String ft, String completeFileName) {
        ...
        Post post = new Post(popupTitle.getText().toString(),
                ...
                imageDownlaodLink,
                currentUser.getUid(),
                currentUser.getPhotoUrl().toString(), SubjectActivity.subjectName, currentUser.getDisplayName(), ft, completeFileName);
        ...
        myRef.setValue(post).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Notifications notification = new Notifications(SubjectActivity.subjectName, key, currentUser.getDisplayName(), currentUser.getPhotoUrl().toString(), notifyRef.getKey());
